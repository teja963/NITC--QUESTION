 ...
 <body class="w3-light-grey">
   <div class="w3-top">
      <div class="w3-bar w3-theme-d2 w3-left-align">
        ...
        <a href="#ElectiveInfo" class="w3-bar-item w3-button w3-teal w3-hide-small w3-hover-white">Elective Info</a>
     ...
     <div class="w3-card-4 w3-margin w3-white">
		 ...
		 $mysqli= new mysqli($host,$user,$pass,$db);
			...
			$query = "SELECT * FROM `Elective_info` WHERE `Course_id` ='$Course_ID'";
				...
				echo "<h4><b>Elective_info:</b></h4><h5> $elective_info</h5	>".'<br />';
				}
			    }
			}
		?>
