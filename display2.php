 ...
 <body class="w3-light-grey">
   <div class="w3-top">
      <div class="w3-bar w3-theme-d2 w3-left-align">
        ...
        <a href="#PlacementInfo" class="w3-bar-item w3-button w3-teal w3-hide-small w3-hover-white">Placement Info</a>
  ...
  <!-- Blog entry -->
     <div class="w3-card-4 w3-margin w3-white">
        <div class="w3-container">
		 ...
		 $mysqli= new mysqli($host,$user,$pass,$db);
			if(isset($_POST['Submit'])){
				...
				echo "<h4><b>Reference:</b></h4><h5> $Reference</h5>".'<br />';
				echo "<h4><b>Interview_exp:</b></h4><h5> $Interview_exp</h5>".'<br />';
				}
			    }
			}
		?>
      ...
      <footer class="w3-container w3-dark-grey w3-padding-32 w3-margin-top">
         <button class="w3-button w3-teal   w3-padding-large w3-margin-bottom w3-theme-l1">Previous</button>
      </footer>
  </body>
</html>
